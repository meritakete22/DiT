...
# For image feature extraction, we will use a pre-trained ResNet-50 model
            ...
            if train_steps % args.log_every == 0:
                ...
                if tb_writer is not None:
                    ...
                    with torch.no_grad():
                        ...
                        pred = denormalize(pred[0].cpu())
                    grid_pred = torchvision.utils.make_grid(pred, normalize=False)

                    tb_writer.add_image("Entrada/epoch",   grid_inp,  epoch)
                    tb_writer.add_image("Condición/epoch", grid_cond, epoch)
                    tb_writer.add_image("Predicción/epoch",grid_pred, epoch)
